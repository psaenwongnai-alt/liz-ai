...
def deploy_vercel():
    ...
    vercel_url = subprocess.getoutput("vercel --prod --token " + VERCEL_TOKEN +
                                      " --confirm | grep -o 'https://.*'")
    log(f"✅ Deployed to Vercel at: {vercel_url if vercel_url else 'URL unknown'}"
        )
